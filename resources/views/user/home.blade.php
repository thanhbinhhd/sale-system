...
@section('content')
    ...
    <section class="slide1">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1 item1-slick1" style="background-image: url(/user/images/master-slide-07.jpg);">
                ...
                <div class="item-slick1 item2-slick1" style="background-image: url(/user/images/master-slide-06.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                ...
                <div class="item-slick1 item3-slick1" style="background-image: url(/user/images/master-slide-02.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
            ...
            <div class="row">
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="/user/images/banner-05.jpg" alt="IMG-BENNER">
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <!-- block1 -->
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="/user/images/banner-03.jpg" alt="IMG-BENNER">
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <!-- block1 -->
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="/user/images/banner-10.jpg" alt="IMG-BENNER">
    ...
    <!-- Banner video -->
    <section class="parallax0 parallax100" style="background-image: url(/user/images/bg-video-01.jpg);">
                ...
                <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                    ...
                    <div class="block3">
                        <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
                            <img src="/user/images/blog-01.jpg" alt="IMG-BLOG">
                        </a>
    ...
    <section class="instagram p-t-20">
        ...
        <div class="flex-w">
            ...
            <div class="block4 wrap-pic-w">
                <img src="/user/images/gallery-03.jpg" alt="IMG-INSTAGRAM">
            ...
            <!-- Block4 -->
            <div class="block4 wrap-pic-w">
                <img src="/user/images/gallery-07.jpg" alt="IMG-INSTAGRAM">
            ...
            <!-- Block4 -->
            <div class="block4 wrap-pic-w">
                <img src="/user/images/gallery-09.jpg" alt="IMG-INSTAGRAM">
            ...
            <!-- Block4 -->
            <div class="block4 wrap-pic-w">
                <img src="/user/images/gallery-13.jpg" alt="IMG-INSTAGRAM">
            ...
            <!-- Block4 -->
            <div class="block4 wrap-pic-w">
                <img src="/user/images/gallery-15.jpg" alt="IMG-INSTAGRAM">
