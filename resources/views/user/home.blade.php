                    ...
                    <div class="tab-pane fade" id="hot" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                                ...
                                <div class="block2">
                                    <div class="block2-img  of-hidden pos-relative block2-labelsale">
                                        <img src="{{$view->image_path}}" style="width: 270px" alt="IMG-PRODUCT">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                    <!-- Block3 -->
                    <div class="block3">
                        <a href="/blog/{{$blog->slug}}" class="block3-img dis-block hov-img-zoom">
                            <img src="{{$blog->thumbnail_path}}" alt="IMG-BLOG">
                        </a>

                        <div class="block3-txt p-t-14">
                            <h4 class="p-b-7">
                                <a href="/blog/{{$blog->slug}}" class="m-text11">
                                    {{$blog->title}}
                                </a>
                            </h4>
